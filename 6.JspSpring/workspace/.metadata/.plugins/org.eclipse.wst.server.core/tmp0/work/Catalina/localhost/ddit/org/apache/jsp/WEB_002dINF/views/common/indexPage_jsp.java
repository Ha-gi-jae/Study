...
public final class indexPage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
      out.write("<body>\r\n");
      out.write("	<div class=\"content-wrapper\" style=\"background-color:#fff;\">\r\n");
      ...
      out.write("// jquery로 dom을 다루는것은 좋지 않음. 모양만들때만 쓰는걸 추천\r\n");
      out.write("// jquery 로딩을 신경써야되니까...\r\n");
      out.write("	$('iframe[name=\"ifr\"]').attr(\"src\",url);\r\n");
      ...
      out.write("		}\r\n");
      out.write("		// 페이지를 리로드 하지않고 페이지 주소만 변경할 때 사용\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("//handlebars printElement (args : data Array, append target, handler template, remove class)\r\n");
      ...
      out.write("	\r\n");
      out.write("	// 순수자바스크립트로 하려면 document.querySelector 쓰면됨.\r\n");
      out.write("	$(removeClass).remove();\r\n");
      out.write("	\r\n");
      out.write("	// 부모로 가서 지워야함. 가장 좋은 방법.\r\n");
      out.write("// 	var child = document.querySelector(removeClass);\r\n");
      out.write("// 	child.parentNode.removeChild(child);\r\n");
      out.write("\r\n");
      out.write("// 	document.querySelectorAll(removeClass).remove(); 인터넷 익스플로러에서는 못씀..\r\n");
      out.write("	target.append(html);\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("window.onload=function(){ // 한번만 써야함. include 포함해서 두번쓰면 에러 남! 임베디드형태로 딱 한번만 써라. 헤더 푸터 어사이드 이런곳에!!\r\n");
      out.write("	goPage('");
      out.print(request.getContextPath());
